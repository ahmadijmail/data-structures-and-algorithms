...
const typeNum = (arr) => {
   ...
   let filtered= arr.filter((elemnt)=> typeof elemnt==="number")
...
const containsAnd = (arr) => {
  let filtered= arr.filter((elemnt)=> elemnt.includes("and"))
  return filtered
};
...
const oddValues = (arr) => {
  let filtered= arr.filter((elemnt)=> elemnt %2 ===1)
  return filtered
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  let filtered= arr.filter((elemnt)=> !forbiddenValues.includes(elemnt))
  return filtered
};
